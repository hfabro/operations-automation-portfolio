...
<link rel="stylesheet" href="../../assets/operations-systems.css?v=20260925.11"><link rel="stylesheet" href="../../assets/demo-series.css?v=20260925.11">
<script src="../../scripts/operations-data.js" defer></script><script src="../../scripts/operations-systems.js?v=20260926.1" defer></script><script src="../../scripts/demo-series.js?v=20260926.1" defer></script><link rel="stylesheet" href="../../assets/microsoft-surfaces.css?v=20260926.1"></head>
...
<section class="ops-app" id="system"${slug==='facility-leaks'?' tabindex="0"':''} aria-label="${title}"><noscript><p>JavaScript is needed to operate this simulation. ${description} All records and diagrams are fictional.</p><a href="../../work/">Read the static case studies</a></noscript></section>
